extern struct usb_interface_assoc_descriptor ncm_iad_desc;
extern struct usb_interface_descriptor ncm_control_intf;
extern struct usb_cdc_header_desc ncm_header_desc;
extern struct usb_cdc_union_desc ncm_union_desc;
extern struct usb_cdc_ether_desc ecm_desc;
extern struct usb_cdc_ncm_desc ncm_desc;
extern struct usb_interface_descriptor ncm_data_nop_intf;
extern struct usb_interface_descriptor ncm_data_intf;
...
static struct usb_ss_ep_comp_descriptor ssp_ncm_intr_comp_desc = {
	.bLength =		sizeof(ssp_ncm_intr_comp_desc),
	.bDescriptorType =	USB_DT_SS_ENDPOINT_COMP,
	.wBytesPerInterval =	cpu_to_le16(NCM_STATUS_BYTECOUNT),
};
...
static struct usb_descriptor_header *ncm_ssp_function[] = {
	...
	(struct usb_descriptor_header *) &ssp_ncm_intr_comp_desc,
	(struct usb_descriptor_header *) &ncm_data_nop_intf,
	(struct usb_descriptor_header *) &ncm_data_intf,
